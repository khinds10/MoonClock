...
class Moon {
	...
	*/
	...
	function phase_image() {
		$names = array( 'new-moon.png','00.png','01.png','02.png','03.png','04.png','05.png','06.png','07.png','08.png','09.png','10.png','11.png','12.png','13.png','14.png','15.png','16.png','17.png','18.png','19.png','20.png','21.png','22.png','new-moon.png' );
		return $names[ floor( ( $this->phase + 0.0625 ) * 24 ) ];
	}

	function get_next_full_moon_time() {
	    $units = "day(s)";
    	$numberDays = ceil(($this->next_full_moon() - time()) / 86400);
	    if ($numberDays > 13) {
            $units = "week(s)";
            $numberDays = floor(($this->next_full_moon() - time()) / (86400 * 7));
	    }
        return $numberDays . " " . $units;
	}
	
	function get_next_new_moon_time() {
	    $units = "day(s)";
    	$numberDays = ceil(($this->next_new_moon() - time()) / 86400);
	    if ($numberDays > 13) {
            $units = "week(s)";
            $numberDays = floor(($this->next_new_moon() - time()) / (86400 * 7));
	    }
        return $numberDays . " " . $units;
	}	
}
